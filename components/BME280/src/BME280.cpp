...
BME280::BME280(I2C& pI2C) : _i2c(pI2C) {
    AddValueSource(new ValueSource(*this,TEMPERATURE,   Fixed, Centigrade, _valTemperature, GET_LATEST_DATA | DEFAULT_MQTT | DEFAULT_DATALOG));       
    AddValueSource(new ValueSource(*this,PRESSURE,      Fixed, hPa,        _valPressure, GET_LATEST_DATA | DEFAULT_MQTT | DEFAULT_DATALOG));       
    AddValueSource(new ValueSource(*this,HUMIDITY,      Fixed, Percent,    _valHumidity, GET_LATEST_DATA | DEFAULT_MQTT | DEFAULT_DATALOG));    
