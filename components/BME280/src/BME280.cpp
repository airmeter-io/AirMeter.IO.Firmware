...
BME280::BME280(I2C& pI2C) : _i2c(pI2C) {
    AddValueSource(new ValueSource(*this,TEMPERATURE,   Fixed, Centigrade, _valHumidity, GET_LATEST_DATA));       
    AddValueSource(new ValueSource(*this,PRESSURE,      Fixed, hPa,        _valPressure, GET_LATEST_DATA));       
    AddValueSource(new ValueSource(*this,HUMIDITY,      Fixed, Percent,    _valTemperature, GET_LATEST_DATA));    
