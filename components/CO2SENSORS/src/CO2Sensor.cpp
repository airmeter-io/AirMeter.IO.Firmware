...
CO2Sensor::CO2Sensor() {
   ...
   AddValueSource(new ValueSource(*this,CO2VALUE_DEVICENAME,               String, Dimensionless, _valDeviceName, GET_LATEST_DATA | DEFAULT_MQTTINFO));
   AddValueSource(new ValueSource(*this,CO2VALUE_SERIALNO,                 String, Dimensionless, _valSerialNo, GET_LATEST_DATA  | DEFAULT_MQTTINFO));
   AddValueSource(new ValueSource(*this,CO2VALUE_SOFWAREVERSION,           String, Dimensionless, _valSwVersion, GET_LATEST_DATA  | DEFAULT_MQTTINFO));
