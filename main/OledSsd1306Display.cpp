...
Oledssd1306Display::Oledssd1306Display(GeneralSettings& pSettings, ValueModel& pValues, Wifi& pWifi, I2C& pI2C) : CO2MonitorDisplay(pSettings, pValues), _wifi(pWifi), _i2c(pI2C) {
